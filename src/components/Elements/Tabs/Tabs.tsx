...
export function Tabs({ items, active, setActive, wrapperClassName }: TabProps) {
  ...
  return (
    <div
      className={cn(['flex flex-row items-center text-primary min-w-[340px]', wrapperClassName])}
    >
      {tabItems}
    </div>
  );
